...
def question_6():
    ...
    def do_test(n, cmd, pi, nsolns, time_bound, complete=True):
        ...
        try:
            ...
            print("{} test timed out. Took > {} sec.".format(cmd, time_bound))
            fails[n] = True
        ...
        if fails[n]:
            ...
            print("Pass Q6 test {}. Took {} sec.".format(n+1, end_time-start_time))
        print_sep()
...
def outputGrades(marks_file=''):
    print_sep('=')
    for i in range(len(grades)):
        if questions_run[i] == 1:
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--marks_file", help="output marks to file")
    ...
    if args.question:
        ...
        try:
            ...
            print("Error in executing question 1")
            print(e)
        try:
            question_2()
        except Exception as e:
            print("Error in executing question 2")
            print(e)
        try:
            question_3()
        except Exception as e:
            print("Error in executing question 3")
            print(e)
        try:
            question_4()
        except Exception as e:
            print("Error in executing question 4")
            print(e)
        try:
            question_5()
        except Exception as e:
            print("Error in executing question 5")
            print(e)
        try:
            question_6()
        except Exception as e:
            print("Error in executing question 6")
            print(e)

    if args.marks_file:
        outputGrades(args.marks_file)
    else:
        outputGrades()
