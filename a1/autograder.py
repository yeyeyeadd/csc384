...
if test_time_astar:
    ...
    time = os.times()[0]
    weight = 2
    final = anytime_weighted_astar(s0, heur_fn=heur_alternate, weight=weight,
                                   timebound=timebound)
    difference = os.times()[0] - time
    print('This amount of time was given: {}'.format(timebound))
    print('Your anytime_weighted_astar used this amoung of time: {}'.format(
        difference))
...
if test_manhattan:
    ...
    correct_man_dist = [2, 8, 3, 3, 8, 7, 11, 11, 10, 12, 12, 13, 10, 13, 10,
                        35, 28, 41, 43, 36]
...
if test_alternate:
    ...
    man_dist_solns = [6, 23, 24, 12, 24, -99, -99, 41, 20, -99, -99, -99, -99,
                      -99, -99, -99, -99, -99, -99, -99]
    better_solns = [6, 23, 20, 12, 24, 32, -99, 41, 20, -99, 73, 52, 64, 39, 40,
                    160, 139, -99, -99, -99]
    ...
    print("Problems that remain unsolved in the set are Problems: {}".format(
        unsolved))
    print(
        "A heuristic that returns 0 solves 5 out of {} practice problems given {} seconds.".format(
            len(PROBLEMS), timebound))
    print(
        "The manhattan distance implementation solved {} out of {} practice problems given {} seconds.".format(
            benchmark1, len(PROBLEMS), timebound))
    print(
        "The better implementation solved {} out of {} practice problems given {} seconds.".format(
            benchmark2, len(PROBLEMS), timebound))
    print("*************************************\n")
    ##############################################################
...
if test_anytime_gbfs:
    ...
    man_dist_solns = [4, 21, 18, 8, 18, -99, -99, 41, 15, -99, -99, -99, -99,
                      -99, -99, -99, -99, -99, -99, -99]
    len_benchmark = [4, 21, 18, 8, 18, 31, -99, 41, 15, -99, 73, 45, 57, 39, 37,
                     160, 137, -99, 259, -99]
    ...
    unsolved = [];
    benchmark = 0;
    timebound = 5  # 5 second time limit
    for i in range(0, len(PROBLEMS)):
        print("*************************************")
        print("PROBLEM {}".format(i))
    ...
    print("Problems that remain unsolved in the set are Problems: {}".format(
        unsolved))
    print(
        "The manhattan distance implementation solved 7 out of the 20 practice problems given 5 seconds.")
    print(
        "The better implementation solved 16 out of the 20 practice problems given 5 seconds.")
    print("*************************************\n")

if test_anytime_weighted_astar:

    man_dist_solns = [4, 21, 10, 8, 17, -99, -99, 41, 14, -99, -99, -99, -99,
                      -99, -99, -99, -99, -99, -99, -99]
    len_benchmark = [4, 21, 10, 8, 18, 31, -99, 41, 14, -99, 36, 30, 28, 31, 27,
                     -99, -99, -99, -99, -99]
    ...
    print(
        "The manhattan distance implementation solved 7 out of the 20 practice problems given 5 seconds.")
    print(
        "The better implementation solved 13 out of the 20 practice problems given 5 seconds.")
    print("*************************************\n")
    ##############################################################
