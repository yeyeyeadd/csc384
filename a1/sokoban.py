...
class SokobanState(StateSpace):
    ...
    def __init__(self, action, gval, parent, width, height, robots, boxes,
                 storage, obstacles):
        '''
        ...
        for robot in range(0, len(self.robots)):
            for direction in (UP, RIGHT, DOWN, LEFT):
                ...
                if new_location in self.boxes:
                    ...
                    if new_box_location[0] < 0 or new_box_location[
                        0] >= self.width:
                        continue
                    if new_box_location[1] < 0 or new_box_location[
                        1] >= self.height:
                        continue
                ...
                new_state = SokobanState(str(robot) + " " + direction.name,
                                         self.gval + transition_cost, self,
                                         self.width, self.height, new_robots,
                                         frozenset(new_boxes), self.storage,
                                         self.obstacles)
...
PROBLEMS = (
    ...
    SokobanState("START", 0, None, 6, 6,  # dimensions
                 ...
                 frozenset(((1, 0), (4, 1), (1, 2), (4, 3), (1, 4), (4, 5))),
                 # boxes
                 frozenset(((5, 0), (0, 1), (5, 2), (0, 3), (5, 4), (0, 5))),
                 # storage
                 frozenset()  # obstacles
                 ),
    SokobanState("START", 0, None, 6, 6,  # dimensions
    ...
    SokobanState("START", 0, None, 8, 8,  # dimensions
                 ...
                 frozenset(((0, 0), (1, 0), (2, 0), (0, 1), (1, 1), (0, 2))),
                 # storage
                 frozenset()  # obstacles
                 ),
    SokobanState("START", 0, None, 8, 8,  # dimensions
    ...
    SokobanState("START", 0, None, 8, 8,  # dimensions
                 ((0, 5), (1, 6), (2, 7)),  # robots
                 frozenset(((5, 4), (5, 5), (6, 3), (4, 2), (6, 5), (5, 3))),
                 # boxes
                 frozenset(((0, 0), (1, 0), (2, 0), (0, 1), (1, 1), (0, 2))),
                 # storage
                 frozenset()  # obstacles
    ...
    SokobanState("START", 0, None, 8, 8,  # dimensions
                 ((0, 5), (1, 6), (2, 7)),  # robots
                 frozenset(((6, 6), (5, 6), (6, 2), (4, 3), (5, 1), (6, 5))),
                 # boxes
                 frozenset(((0, 0), (1, 0), (2, 0), (0, 1), (1, 1), (0, 2))),
                 # storage
                 frozenset()  # obstacles
    ...
    SokobanState("START", 0, None, 8, 8,  # dimensions
                 ((0, 5), (1, 6), (2, 7)),  # robots
                 frozenset(((6, 6), (4, 5), (4, 1), (4, 3), (5, 2), (5, 3))),
                 # boxes
                 frozenset(((0, 0), (1, 0), (2, 0), (0, 1), (1, 1), (0, 2))),
                 # storage
                 frozenset()  # obstacles
